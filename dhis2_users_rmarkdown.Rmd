...
An update may be a _new_ data value being entered into a stage, _or_ editing an existing value. A deletion is an erasure of an existing data value.
...
## Users and User Groups {.tabset .tabset-fade}
...
```{r top users, echo=FALSE, eval=FALSE, fig.height=2}
