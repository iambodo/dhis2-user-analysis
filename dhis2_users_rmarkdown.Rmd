...
##SEE MANUAL STEPS FOR CONFIGURATION BELOW

##first load required packages
required_packages <- c("ggplot2", "stringr","httr","jsonlite","assertthat","rlist","readr",         "tibble","plyr","gridExtra","cowplot","knitr","askpass","DT","knitr","keyring")
